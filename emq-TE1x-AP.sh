...
2)
sudo sh /opt/YSF2DMR/DMRIDUpdate.sh && sudo systemctl enable ysf2dmr.service && cronedit.sh '0 3 * * *' 'sh /opt/YSF2DMR/DMRIDUpdate.sh' add && cronedit.sh '@reboot' 'sh /opt/YSF2DMR/DMRIDUpdate2.sh' add ;;
3)
